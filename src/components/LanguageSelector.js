...
const Selector = () => {
  ...
  const setLanguage = code => {
    ...
    NativeModules.RnStorageModule.readStorageValue(
      'UserLanguage',
      code,
      (err, name) => {
        console.log('readStorageValue  ====================>', err, name);
      },
    );
    NativeModules.RnStorageModule.getDeviceName((err, name) =>
      console.log('getDeviceName =====>', err, name),
    );
